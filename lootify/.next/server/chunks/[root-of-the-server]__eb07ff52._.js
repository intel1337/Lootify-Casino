...
async function POST(request) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
            where: {
                id: userId
            }
        });
